...
public class GlobalClock {
    ...
    public static void systemTimingSetUp(Core[] cores) {
         ...
         * }
         * }
         * for (Enumeration<String> cacheNameSet = cacheList.keys();
         * cacheNameSet.hasMoreElements(); )
         * {
         ...
         * }
         * time_periods[i] =
         * Math.round(100000000/MemorySystem.mainMemory.getFrequency());
         * if(time_periods[i] < seed)
         * {
         * seed = time_periods[i];
         * }
         ...
         * {
         * flag = true;
         * for(j = 0; j < SystemConfig.NoOfCores +
         * SystemConfig.declaredCaches.size() + 1; j++)
         * {
        ...
        // freq_list[i] =
        // Math.round(MemorySystem.mainMemory.getFrequency()/100);
        ...
        /*
         * for (Enumeration<String> cacheNameSet = cacheList.keys();
         * cacheNameSet.hasMoreElements(); Nothing)
         * {
         * cacheName = cacheNameSet.nextElement();
         * cache = cacheList.get(cacheName);
        ...
        for (i = 0; i < SystemConfig.NoOfCores; i++) {
            // System.out.println("step size of core " + i + " is " +
            // cores[i].getStepSize());
        }
        /*
         * for (Enumeration<String> cacheNameSet = cacheList.keys();
         ...
         * cacheName = cacheNameSet.nextElement();
         * cache = cacheList.get(cacheName);
         * System.out.println("step size of cache " + (i -
         * SystemConfig.NoOfCores) + " is " + cache.getStepSize());
         * //System.out.println(cache.getStepSize());
         * }
         * System.out.println("step size of main memory is " +
         * MemorySystem.mainMemory.getStepSize());
         */
    }
    ...
    public static EnergyConfig calculateAndPrintEnergy(
            FileWriter outputFileWriter, String componentName)
            throws IOException {

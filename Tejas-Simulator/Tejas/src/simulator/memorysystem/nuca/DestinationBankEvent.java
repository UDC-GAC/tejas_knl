...
public class DestinationBankEvent extends AddressCarryingEvent
{
	...
	public DestinationBankEvent updateEvent(EventQueue eventQ, long eventTime, 
		...
		System.out.println("updateEvent.SourceBankId: " + sourceBankId.toString());
		System.out.println("updateEvent.DestinationBankEvent: " + destinationBankId.toString());
	...
	public Vector<Integer> getSourceBankId() {
	    System.out.println("sourceBankId: " + sourceBankId.toString());
		return sourceBankId;
	}

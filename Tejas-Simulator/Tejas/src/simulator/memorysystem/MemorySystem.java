...
public class MemorySystem
{
    ...
    public static Cache createSharedCacheCores(String token, int t, CommunicationInterface comInterface) {
	for(CacheConfig config : SystemConfig.sharedCacheConfigs) {
	    if (!config.isDirectory) {
		Cache c = null;
		c = new Cache(token + "[" + t + "]", t, config, null);
    ...
    public static Coherence createCHA(String token, int t, CommunicationInterface comInterface) {
	for(CacheConfig config : SystemConfig.sharedCacheConfigs) {
	    if (config.isDirectory) {
		Cache c = null;
